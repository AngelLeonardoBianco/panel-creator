...
<html lang="en">
	...
	<body class="login tooltips">
		...
		<div class="login-wrapper">
			...
			<li><a href="register.php"><i class="fa fa-bomb icon-sidebar"></i>FORMULARIO REGISTRO</a></li>		
			<li><a href="login.php"><i class="fa fa-bomb icon-sidebar"></i>PANEL LOGIN</a></li>	
			<li><a href="dashboard.php"><i class="fa fa-bomb icon-sidebar"></i>DASHBOARD</a></li>	
