	...
	<body class="login tooltips">
		...
		<div class="login-wrapper">
			...
			<form role="form">
				...
				<div class="form-group has-feedback lg left-feedback no-label">
				  <input type="text" class="form-control no-border input-lg rounded" placeholder="Usuario">
				  <span class="fa fa-user form-control-feedback"></span>
				</div>
				<div class="form-group has-feedback lg left-feedback no-label">
				  <input type="email" class="form-control no-border input-lg rounded" placeholder="Email">
				...
				<div class="form-group">
				  <div class="checkbox">
					<label class="inline-popups">
					  <input type="checkbox" class="i-yellow-flat"> Acepto <a href="#text-popup" data-effect="mfp-zoom-in">Terminos y condiciones</a>
					</label>
				  </div>
				</div>
				<div class="form-group">
			...
			<div class="alert alert-warning alert-bold-border fade in alert-dismissable">
			  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
			  Una vez registrado podrá acceder al panel, pero no podrá hacer uso completo del sistema hasta no completar los datos de su perfil.
			</div>
		</div><!-- /.login-wrapper -->
