$(document).ready(function () {
    ...
    $("#username2").keyup(function (e) {
        ...
        var user_name2 = $(this).val();
        if (user_name2 != '') {
            x_timer = setTimeout(function () {
                check_username_existence(user_name2);
            }, 1000);
        }
    });

    function check_username_existence(username2) {
        $("#disp2").html('<img src="assets/js/ajax-loader.gif" width="24px" />');
        $.post('assets/js/usernameChk.php', {'username': username2}, function (data) {
            $("#disp2").html(data);
        });
