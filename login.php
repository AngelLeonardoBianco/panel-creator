	...
	<body class="login tooltips">
		...
		<div class="login-wrapper">
			<div class="alert alert-warning alert-bold-border fade in alert-dismissable">
			  ...
			  <strong>ACCESO RESTRINGIDO!</strong> Este acceso solo está permitido para clientes registrados <a href="http://mlmgestion.com" class="alert-link">Volver al sitio</a>.
			</div>
			<form role="form" action="cbr/chkUser.php" method="post" >
				...
				<div class="form-group">
				  <div class="checkbox">
					<label>
					  <input type="checkbox" class="i-yellow-flat"> Recordarme
					</label>
				  </div>
				</div>
				<div class="form-group">
					<button type="submit" class="btn btn-warning btn-lg btn-perspective btn-block">ACCEDER</button>
				</div>
			</form>
			<p class="text-center"><strong><a href="forgot-password.php">No recuerda password?</a></strong></p>
			<p class="text-center">o</p>
			<p class="text-center"><strong><a href="register.php">Registrarse en mlmgestion</a></strong></p>
			<p class="text-center"><strong><a href="dashboard.php">ACCESO SIN CLAVE (PROVISORIO)</a></strong></p>
		</div><!-- /.login-wrapper -->
		<!--
		===========================================================
		END PAGE
