...
<html lang="en">
	<head>
		...
		<meta name="description" content="GoodHouse, el sitio inmobiliario para personas serias">
		<meta name="keywords" content="administracion, goodhouse, gestor inmobiliario">
		<meta name="author" content="Damian Tirante, CEO y desarrollador de GoodHouse">
		<title>GOODHOUSE - BACKOFFICE ADMINSTRACIÓN GENERAL</title>
 

		<!-- BOOTSTRAP CSS (REQUIRED EN TODAS LAS PAGINAS)-->
		...
		<!-- CSS PRINCIPAL (REQUERIDO EN TODAS LAS PAGINAS)-->
	...
	<body class="tooltips">
		...
		<div class="wrapper">
			...
			<div class="page-content">
				...
				<h1 class="page-heading">#NOMBREUSUARIO <small>Última actualización 99/99/9999 - 00:00</small></h1>
				<!-- FIN TITULO PAGINA PRINCIPAL -->
				
					<!-- COMIENZA ALERTA -->
					<?php include("alerta_1.php"); ?>
					<!-- TERMINA ALERTA -->
					aqui colocamos contendidos
				</div><!-- /.container-fluid -->
